...
public extension Kernels {
    struct AttentionOutput: Kernel {
        ...
        public init(
            ...
            grid = MTLSize(width: batch, height: queryHeads, depth: queryLen * headDim)
        }
        ...
        public let threadgroupSize = MTLSize(width: 1, height: 1, depth: 64)
